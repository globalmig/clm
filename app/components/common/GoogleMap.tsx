...
export default function GoogleMap() {
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-4 border rounded-lg p-4 bg-white  mb-4 md:mb-10">
        <p className="border-r-2 text-center">오시는길</p>
        <p>서울 금천구 두산로 70 B동 327호(현대지식산업센터)</p>
      </div>
    </div>
  );
}
